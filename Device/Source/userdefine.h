...
#else
#define INTP1_PORT_SETTING() do{ \
        PORT->INTP1PCFG = 0x0b;     /* allocate INTP1 to P20 */ \
        PORT->PM2  |=  (1 << 0);    /* P20 is used as INTP1 input */ \
        PORT->PMC2 &= ~(1 << 0);    /* P20 digital function */ \
}while(0)
...
#define INTP2_PORT_SETTING() do{ \
        PORT->INTP2PCFG = 0xd;     /* allocate INTP2 to P22 */ \
        PORT->PM2  |=  (1 << 2);    /* P22 is used as INTP2 input */ \
        PORT->PMC2 &= ~(1 << 2);    /* P22 digital function */ \
}while(0)
